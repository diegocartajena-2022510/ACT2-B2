...
public class VentasController {
    ...
    @PostMapping
    public ResponseEntity<Object> createClientes( @RequestBody Ventas ventas){
        try{
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> updateVentas(@PathVariable Integer id, @RequestBody Ventas ventas) {
        try{
